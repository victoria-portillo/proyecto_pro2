const moduloDatos = {
    ...
    productos: [
      ...
      },
      {
        ...
        descripción: 'Esta novela corta cuenta la historia de un niño que viaja de planeta en planeta y se encuentra con varios personajes que representan diferentes aspectos de la vida humana. "El principito" es una obra tierna y poética que ha sido traducida a más de 250 idiomas.',
        imagen: '../public/images/products/principito.jpeg',
        fechaCarga: ''
      },
      {
        nombre: 'La casa de los espíritus',
        descripción: 'Esta novela sigue la historia de la familia Trueba a lo largo de varias décadas en Chile. "La casa de los espíritus" es una obra que combina elementos del realismo mágico con la política y la historia de América Latina.',
        imagen: '../public/images/products/casa-espiritus.jpeg',
        fechaCarga: ''
      }
    ],
    comentarios: [
